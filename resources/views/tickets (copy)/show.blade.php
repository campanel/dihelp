...
@section('content')
    ...
    <div class="mdl-card__supporting-text">
        {{ link_to_route('tickets.edit', 'Atualizar Ticket', array($ticket->id), array('class' => 'mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored mdl-color-text--white')) }}
    </div>
